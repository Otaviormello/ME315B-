...
SELECT DISTINCT DNO, SALARY FROM EMPLOYEE
```
O resultado final possui a mesma quantidade de linhas em todos os casos,pois não existe valores dulicados.
...
Apenas a primeira e a terceira são equivalentes. 
